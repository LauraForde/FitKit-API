...
if __name__ == '__main__':
    app = connexion.App(__name__, specification_dir='FitKit-API/', arguments={'global':'global_value'})  # Provide the app and the directory of the docs specification_dir='swagger/'
